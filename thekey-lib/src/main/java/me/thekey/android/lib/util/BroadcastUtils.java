...
public final class BroadcastUtils {
    public static void broadcastLogin(@NonNull final Context context, @NonNull final String guid) {
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(ACTION_LOGIN).putExtra(EXTRA_GUID, guid));
    }

    public static void broadcastLogout(@NonNull final Context context, @NonNull final String guid,
    ...
    public static void broadcastAttributesLoaded(@NonNull final Context context, @NonNull final String guid) {
        LocalBroadcastManager.getInstance(context).sendBroadcast(
